        ...
        <Navbar collapseOnSelect expand ="sm" bg="dark" variant="dark">
            ...
            <Navbar.Collapse id="navbarScroll">
                <Nav>
                    ...
                    <NavLink eventKey="2" as={Link} to="/emissionSources">Lämpötilatiedot ja co2 pitoisuudet</NavLink>
                    <NavLink eventKey="3" as={Link} to="/temperature">Päästölähteet</NavLink>
